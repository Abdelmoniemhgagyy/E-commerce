...
import { Accordion,  AccordionSummary, Box, Container, Drawer, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Stack, Typography } from "@mui/material";
...
function Header3() {
  ...
  const list = (anchor) => (
    ...
    >
      <IconButton   onClick={toggleDrawer(anchor, false)} sx={{position:"absolute",top:"15px",right:"10px",
  ...
  return (
    <Container sx={{display:"flex",justifyContent:"space-between",alignItems:"center",mt:5}}>
      <Box>
        ...
        >
          <WindowIcon mr={2}/>
          <Typography sx={{textTransform:"capitalize",color:theme.palette.white,mx:1}}>
            Categories
          </Typography>
          <Box flexGrow={1}/>
        <ExpandMoreIcon/>
